...
static struct clkctl_acpu_speed acpu_freq_tbl_1782mhz[] = {
  ...
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(19), 1275000, 0x03006000},
				 ...
				 enum setrate_reason reason)
{
	...
	set_acpuclk_cpu_freq_foot_print(cpu, tgt_s->acpuclk_khz);
	...
	set_acpuclk_L2_freq_foot_print(tgt_l2->khz);
...
static __init struct clkctl_acpu_speed *select_freq_plan(void)
{
	...
	acpu_freq_tbl = acpu_freq_tbl_1782mhz;
