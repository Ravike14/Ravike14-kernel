 ...
 * Modified (c) 2013 Ravishka Fernando <rn.fernando3@gmail.com>
 *
...
static int mipi_dsi_panel_power(const int on)
{
	...
	if (!dsi_power_on) {
		...
		rc = regulator_set_voltage(rgl_l19, 3000000, 3000000);
		if (rc) {
			PR_DISP_ERR("%s: error setting l19_2v85 voltage\n", __func__);
			return -EINVAL;
		}

		rc = regulator_set_voltage(rgl_l20, 1800000, 1800000);
		if (rc) {
...
static struct dsi_cmd_desc ruy_auo_cmd_on_cmds[] = {
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 0},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 4},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 6},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 8},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 10},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 12},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 14},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 16},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 18},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 20},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 22},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 24},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 26},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 28},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 30},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 32},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 34},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 36},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 38},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 40},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 42},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 44},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 46},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 48},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 50},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 52},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 54},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 56},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 58},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 60},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 62},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 64},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 66},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 68},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 70},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 72},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 74},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 76},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 78},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 80},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 82},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 84},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 86},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 88},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 90},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 92},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 94},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 96},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 98},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 100},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 102},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 104},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 106},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 108},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 110},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 112},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 114},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 116},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 118},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 120},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 122},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 124},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 126},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 128},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 130},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 132},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 134},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 136},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 138},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 140},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 142},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 144},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 146},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 148},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 150},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 152},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 154},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 156},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 158},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 160},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 162},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 164},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 166},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 168},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 170},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 172},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 174},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 176},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 178},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 180},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 182},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 184},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 186},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 188},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 190},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 192},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 194},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 196},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 198},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 200},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 202},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 204},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 206},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 208},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 210},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 212},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 214},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 216},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 218},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, 2, ruy_auo_gm + 220},
...
static int ruby_lcd_on(struct platform_device *pdev)
{
	...
	if (!first_init) {
		if (mipi->mode == DSI_CMD_MODE) {
			if (panel_type == PANEL_ID_PYD_AUO_NT) {
				cmdreq.cmds = ruy_auo_cmd_on_cmds;
				cmdreq.cmds_cnt = ARRAY_SIZE(ruy_auo_cmd_on_cmds);
...
#define PWM_MIN                   9      
#define PWM_DEFAULT_AUO           83     
#define PWM_DEFAULT_SHARP		  100	
#define PWM_MAX                   255

#define PWM_DEFAULT	\
	(panel_type == PANEL_ID_PYD_AUO_NT ? PWM_DEFAULT_AUO:PWM_DEFAULT_SHARP)

static unsigned char ruby_shrink_pwm(int br)
{
	...
	if (br <= 0) {
		shrink_br = 0;
			...
			shrink_br = (br - 30) * (PWM_DEFAULT - PWM_MIN) /
		(BRI_SETTING_DEF - BRI_SETTING_MIN) + PWM_MIN;
	} else if (br > BRI_SETTING_DEF && br <= BRI_SETTING_MAX) {
			shrink_br = (br - 143) * (PWM_MAX - PWM_DEFAULT) /
